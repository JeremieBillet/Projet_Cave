...
public class Spiritueux extends Alcool {
	...
	public Spiritueux(int idProduit, String designation, String description, double prix, int quantite, boolean selectionne,
	...
	public Spiritueux(String designation, String description, double prix, int quantite, byte[] photo, double promo, CatPays pays, CatType type) {
	...
	public Spiritueux(String designation, String description, double prix, int quantite, byte[] photo, CatPays pays, CatType type) {
